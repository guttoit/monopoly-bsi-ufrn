...
public class Jogo {
    ...
    private CartaSorteReves nomeDacarta;
    ...
    private CartaSorteReves  volte3Espaços;
    ...
    private CartaSorteReves  seusEmpréstimosEInvestimentoFizeramAniversário;
    ...
    public void cartasSorteReves() {

      nomeDacarta  = factory.criaCartasSorteReves(baralho, 1, "nomeDacarta", "Receba $200", "");
      ...
      avanceParaStCharlesPlace = factory.criaCartasSorteReves(baralho, 3, "avanceParaStCharlesPlace ", " Se não tiver dono você pode comprá-lo do banco.Se tiver, lance os dados e pague ao dono 10 vezes o resultado do lançamento.", " O jogador não recebe $200 se passar pelo Ponto de Partida. ");

      avanceOPeaoParaOServicoPublicoMaisProximo = factory.criaCartasSorteReves(baralho, 4, "avanceOPeaoParaOServicoPublicoMaisProximo ", "Pague ao dono duas vezes o valor que ele deveria receber normalmente.Se a ferrovia não tiver dono, você pode comprá-la do banco.", " O jogador não recebe $200 se passar pelo Ponto de Partida. ");

      avanceOPeaoParaAFerroviaMaisProxima = factory.criaCartasSorteReves(baralho, 5, "avanceOPeaoParaAFerroviaMaisProxima", "$50", "");

      oBancoLhePagouDividendosDe = factory.criaCartasSorteReves(baralho, 6, "oBancoLhePagouDividendosDe", "", "");

      volte3Espaços = factory.criaCartasSorteReves(baralho, 7, "volte3Espaços ", "Não passe pelo ponto de partida, não receba $200.", "");
      ...
      facaAmanutencaoDeTodasAsSuasPropriedades = factory.criaCartasSorteReves(baralho, 9, " facaAmanutencaoDeTodasAsSuasPropriedades ", "Para cada casa pague $25, para cada hotel $10.", " Somente para casas e hotéis que  ");
      ...
      seusEmpréstimosEInvestimentoFizeramAniversário = factory.criaCartasSorteReves(baralho, 15, " seusEmpréstimosEInvestimentoFizeramAniversário ", "Receba $150", "");
